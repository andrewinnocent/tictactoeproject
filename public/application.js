...
var clickEvents = __webpack_require__(9);
...
var onNewGame = function onNewGame() {
  api.newGame().then(ui.createGameSuccess).catch(ui.createGameFailure);
};
// Game restart
...
var boxSelect = function boxSelect() {
  for (var i = 0; i < gameBoard.length; i++) {
    $('#' + i).click(function () {
      // applies the click method to a specific grid space (div)
      if (turn % 2 === 0) {
